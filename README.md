...
## Team Members:
  - Sourav Chahar (B23EE1071)
  - Deepanshu Payal (B23CS1012)
  - Harsh Kumar (B23EE1025)
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/DeepanshuPayal123/prml_course_project_2025.git
2. ```bash
   cd prml_course_project_2025
3. ```bash
